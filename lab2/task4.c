...
int isKeyword(const char *str) {
    const char *keywords[] = {"int", "char", "float", "if", "else", "while", "for", "main"};
...
// Function to recognize identifiers or keywords
        ...
        switch (state) {
            ...
            case 1:
                ...
                if (isalnum(c)) {
                    ...
                    buffer[i] = '\0';
                    if (isKeyword(buffer)) {
                        return newToken("keyword", buffer);
                    } else {
